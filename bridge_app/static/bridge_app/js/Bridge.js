...
function init() {
    ...
    const woodTexture = textureLoader.load('/static/bridge_app/texture/worn_planks_diff_4k.jpg');

    const loader = new THREE.TDSLoader();
    loader.load('/static/bridge_app/3dmodel/Bridge.3ds', function (object) {
        model = object;
